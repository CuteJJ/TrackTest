                                            ...
                                            <div class="printer-right">
                                                ...
                                                <div class="printer-actions">
                                                    ...
                                                    <button class="btn-mini ghost" onclick="openEditPrinterImageModal(<?= $p['id'] ?>, '<?= htmlspecialchars($p['model_name'], ENT_QUOTES) ?>')">
                                                        <span class="material-symbols-outlined">edit</span> Edit Printer
                                                    </button>

                                                    <form method="POST" onsubmit="if(confirm('DELETE this printer and ALL its cases? This action cannot be undone.')){ window.showLoader(); return true; } else { return false; }" class="no-loader" style="margin:0;">
                                                        ...
                                                        <button type="submit" name="delete_printer" class="btn-mini ghost" style="color:var(--error); border-color:var(--error);">
                                                            <span class="material-symbols-outlined">delete</span> Delete Printer
                                                        </button>
                                                    </form>
                                                </div>
                                            </div>
...
<div class="modal-overlay" id="editPrinterProfileModal">
    <div class="modal-box" style="max-width: 450px;">
        <div class="modal-header">
            <h3>Edit Printer</h3>
            <button type="button" class="modal-close-btn" onclick="closeModal('editPrinterProfileModal')"><span class="material-symbols-outlined">close</span></button>
        </div>
        
        <form method="POST" id="editPrinterForm" class="modal-body">
...
<div class="modal-overlay" id="cropperModal" style="z-index: 10000;">
    <div class="modal-box" style="max-width: 600px;">
        <div class="modal-header">
            <h3>Crop Printer Image</h3>
            <button type="button" class="modal-close-btn" onclick="closeCropper()"><span class="material-symbols-outlined">close</span></button>
        </div>
        <div class="modal-body" style="padding:0; background:var(--bg-body);">
            <div class="img-container" style="width: 100%; height: 350px; overflow: hidden;">
                <img id="imageToCrop" src="" style="max-width: 100%; display: block;">
            </div>
        </div>
        <div style="padding: 16px 24px; border-top: 1px solid var(--border); display:flex; justify-content:flex-end; gap:12px;">
            <button type="button" class="btn ghost" style="width: auto; background: transparent; border: 1px solid var(--border); color: var(--text-main);" onclick="closeCropper()">Cancel</button>
