...
<head>
    ...
    <title>Forgot Password | Track Manager</title>
    ...
    .login-footer a:hover .hover-text { text-decoration: underline; }
...
<body>
    ...
    <div class="login-left">
        <div class="form-wrapper">
            ...
            <p class="login-subtitle">Enter your registered email address and we'll send you a secure link to reset your password.</p>
