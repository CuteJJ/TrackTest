...
if ($form_data) {
    ...
    // Use existing task data as default
    $form_data = [
...
// Build user map for avatar fetching
$user_map = [];
...
foreach ($rows as $row) {
    ...
    if ($task['testing_type'] === 'Smoke') {
        ...
        // Push the Main tester to the top of the array so JS parses them correctly
...
if ($validation_failed) {
    // If validation failed, restore the user's unsaved attempts
    $saved_reg_urls = [];
